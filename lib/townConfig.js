...
export const WORLD = { w: 1800, h: 1000 };
...
export const PLAZA = { x: 900, y: 566 };
...
export const BUILDING_INFO = {
  ...
  nap: { produces: null, desc: "Every cat needs a bed. This building alone decides how many cats can be on shift at once.", unlocksAt: (lvl) => `${lvl} cat${lvl === 1 ? "" : "s"} on shift` },
