...
export const LANES = { back: 344, front: 452 };
...
export const BUILDING_INFO = {
  ...
  nap: { produces: null, desc: "Beds where tired cats sleep off their Stamina. Beds are limited — when they are full, tired cats sit idle and the town slows down.", unlocksAt: (lvl) => `${1 + lvl * 2} beds` },
  kitchen: { produces: "kibble", desc: "Cooks Kibble. Working cats eat it." },
  treats: { produces: "treats", desc: "Bakes Treats, the currency everything else is priced in." },
  lumber: { produces: "planks", desc: "Shreds scratching posts into Planks for construction." },
  quarry: { produces: "pebbles", desc: "Cuts Pebbles for construction." },
  garden: { produces: "catnip", desc: "Grows Catnip, which restores Happiness." },
