...
export const CHAPTERS = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "c2t2", text: "Have 3 cats working", goal: 3, at: (s) => assigned(s), reward: { fish: 200, treats: 400 } },
      { id: "c2t3", text: "Hold 1,500 Fish", goal: 1500, at: (s) => s.res?.fish || 0, reward: { wood: 200, stone: 50 } },
      { id: "c2t4", text: "Grow the Nap House to level 2", goal: 2, at: (s) => lvl(s, "nap"), reward: { wood: 200, fish: 150, stone: 50, gold: 10 } },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "c4t3", text: "Have 6 cats working", goal: 6, at: (s) => assigned(s), reward: { fish: 400, treats: 1200 } },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "c5t3", text: "Have 9 cats working", goal: 9, at: (s) => assigned(s), reward: { fish: 600, stone: 250, catnip: 100 } },
