...
export const RARITIES = {
  common: { key: "common", name: "Common", odds: 60, mult: 1, color: "#cbb6c4", shards: 3 },
  rare: { key: "rare", name: "Rare", odds: 25, mult: 3, color: "#4ea8ff", shards: 4 },
  epic: { key: "epic", name: "Epic", odds: 10, mult: 9, color: "#b06bff", shards: 5 },
  legendary: { key: "legendary", name: "Legendary", odds: 4, mult: 30, color: "#FFD700", shards: 6 },
  mythic: { key: "mythic", name: "Mythic", odds: 1, mult: 100, color: "#ff4d6d", shards: 8 },
};
...
export const game = {
  ...
  // Deliberately SUB-LINEAR and capped. A whale gets a real edge but never an
  // absurd one, so free players still fill the leaderboard and the town feels
  // alive. Tiers, not a formula, so it is trivial to explain in one screen.
  holdTiers: [
    { min: 0, mult: 1.0, name: "Stray" },
    { min: 100_000, mult: 1.15, name: "Housecat" },
    { min: 1_000_000, mult: 1.35, name: "Fat Cat" },
    { min: 10_000_000, mult: 1.75, name: "Tubby" },
    { min: 50_000_000, mult: 2.25, name: "Absolute Unit" },
  ],
  ...
  board: {
    minHoldToRank: 100_000,
    plushieTopN: 10, // top 10 each season get the ultra-rare collectible plushie
  },
};
