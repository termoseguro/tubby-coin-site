...
export const config = {
  ...
  care: {
    cause: "children's homes and care institutions in Rio de Janeiro",
    ...
    drives: [
      {
        ...
        // Stills from the same drive, same redaction. Confirm they fall under
        // the same written grant before flipping publishPeoplePhotos — and note
        // they are gitignored, so publishing them is two steps, not one.
        people: [
