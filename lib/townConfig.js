 ...
 *
 *  THE UNLOCK LADDER IS KINGSHOT'S, LEVEL FOR LEVEL:
 *
 *      start  Sawmill        → Lumber Yard        (the first production building)
 *      TC2    Mill           → Kitchen
 *      TC3    Quarry         → Stone Quarry
 *      TC4    Hero Hall      → Adoption Center    (and TC5 needs it at level 1)
 *      TC5    Iron Mine      → Catnip Garden
 *      TC6    Alliance       → Cat Clinic, Watchtower
 *      TC7    Barracks       → Training Yard
 *      TC8    Embassy, Range → Guild Hall, Slingshot Range
 *      TC9    Academy        → The Study, Storehouse
 *      TC10   Command Center → War Room
 *      TC20   Mastery Forging→ Golden Forge
 *
 *  A new town therefore opens with a Cat Hall, a Lumber Yard and ONE cottage.
 *  Nothing else. Starting the player with everything is the fastest way to make
 *  a city builder boring, because there is nothing left to want.
 *
...
export const BUILDINGS = [
  ...
  },
  {
    ...
    x: 1852, y: 1040, w: 142, h: 100, scale: 1.1, ring: 1,
    unlockAt: 4,
  ...
  },
  {
    ...
    x: 2373, y: 512, w: 134, h: 90, scale: 1.0, ring: 4,
    unlockAt: 11,
...
for (const id of COTTAGE_IDS) {
  BUILDING_INFO[id] = {
    produces: null,
    cottage: true,
    desc: "Homes for cat villagers. Every bed is another cat living in town. Cats you put inside buildings produce resources; the rest stay home and earn Gold — so a full town is never a wasted one.",
