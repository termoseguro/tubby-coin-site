...
/** Builders past the two you start with. The third is the classic gateway
 *  purchase in this genre and is priced to be an easy yes; the rest climb. */
export function builderCost(current) {
  return [0, 0, 500, 1400, 3000, 6000][current] ?? 9999;
}
